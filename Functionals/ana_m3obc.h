...
!
!! svn $Id: ana_m3obc.h 751 2015-01-07 22:56:36Z arango $
!!======================================================================
...
!
     ...
     &    DOMAIN(ng)%Eastern_Edge(tile)) THEN
        DO k=1,N(ng)
          DO j=JstrT,JendT
            BOUNDARY(ng)%u_east(j,k)=fac*0.1_r8
          END DO
          DO j=JstrP,JendT
            BOUNDARY(ng)%v_east(j,k)=0.0_r8
          END DO
     ...
     &    DOMAIN(ng)%Western_Edge(tile)) THEN
        DO k=1,N(ng)
          DO j=JstrT,JendT
            BOUNDARY(ng)%u_west(j,k)=fac*0.1_r8
          END DO
          DO j=JstrP,JendT
            BOUNDARY(ng)%v_west(j,k)=0.0_r8
          END DO
     ...
     &    DOMAIN(ng)%Southern_Edge(tile)) THEN
        DO k=1,N(ng)
          DO i=IstrP,IendT
            BOUNDARY(ng)%u_south(i,k)=fac*0.1_r8
          END DO
          DO i=IstrT,IendT
     ...
     &    DOMAIN(ng)%Northern_Edge(tile)) THEN
        DO k=1,N(ng)
          DO i=IstrP,IendT
            BOUNDARY(ng)%u_north(i,k)=fac*0.1_r8
          END DO
          DO i=IstrT,IendT
